				...
				<form action="javascript:;" method="POST" class="login-form" data-action="<?= WEBSITE_DOMAIN; ?>/login/signin" autocomplete="off">
					...
					<div class="mb-3">
						<label for="" class="text-muted mb-2">Email</label>
						 <input type="email" name="email" class="form-control form-control-lg email border-0 bg-light" placeholder="e.g., john@doe.com">
						 <small class="error email-error text-danger"></small>
					</div>
					<div class="mb-3">
						<label for="" class="text-muted mb-2">Password</label>
						<input type="password" name="password" class="form-control form-control-lg password border-0 bg-light" placeholder="&#9679;&#9679;&#9679;&#9679;&#9679;&#9679;&#9679;">
